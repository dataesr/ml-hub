...
export default function JobsInfere() {
    ...
    <Container className="fr-my-3w">
      ...
      <Container fluid style={{ maxWidth: "600px" }}>
        <SmartTextInput
          ...
          label="Model Name"
          hint="HuggingFace repository of the model to infere."
        ...
        />
        <SmartTextInput
          value={inputs.dataset_split || ""}
          onChange={(value) => handleInputsChange("dataset_split", value)}
          onError={(value) => handleErrorsChange("dataset_split", value)}
          validateSync={(value) => validateText(value, true)}
          label="Dataset Split"
          hint="Name of the dataset split."
          placeholder="eval"
        />
        <SmartTextInput
